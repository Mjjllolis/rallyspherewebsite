...
const BackgroundTexture = () => (
  <>
    ...
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-[1]">
      ...
      <div className="absolute w-80 h-80 bg-blue-500/8 rounded-full top-10 -right-16 sm:-right-20" />
      <div className="absolute w-72 h-72 bg-white/6 rounded-full bottom-10 left-10" />
      <div className="absolute w-64 h-64 bg-blue-500/10 rounded-full -bottom-20 -right-8 sm:-right-10" />
      
      {/* Medium circles */}
      <div className="absolute w-30 h-30 bg-white/8 rounded-full top-16 left-5" />
      <div className="absolute w-20 h-20 bg-white/6 rounded-full top-36 right-4 sm:right-8" />
      <div className="absolute w-40 h-40 bg-white/5 rounded-full bottom-48 left-20" />
      <div className="absolute w-24 h-24 bg-white/7 rounded-full bottom-20 right-6 sm:right-12" />
      
      {/* Large geometric shapes */}
      <div className="absolute w-32 h-32 bg-blue-500/12 rounded-3xl bottom-60 left-8 transform rotate-12" />
      <div className="absolute w-28 h-28 bg-blue-500/15 rounded-3xl top-20 right-6 sm:right-10 transform -rotate-12" />
      ...
      <div className="absolute w-20 h-20 bg-blue-500/12 rounded-2xl top-20 right-6 sm:right-10 transform -rotate-20" />
      
      {/* Floating dots */}
      <div className="absolute w-3 h-3 bg-white/20 rounded-full top-48 left-16" />
      <div className="absolute w-2 h-2 bg-blue-500/30 rounded-full top-72 right-16 sm:right-24" />
      <div className="absolute w-4 h-4 bg-white/15 rounded-full bottom-96 left-36" />
      <div className="absolute w-2.5 h-2.5 bg-blue-500/25 rounded-full bottom-44 right-12 sm:right-20" />
      <div className="absolute w-3.5 h-3.5 bg-white/18 rounded-full top-96 left-48" />
      <div className="absolute w-5 h-5 bg-white/12 rounded-full top-80 right-20 sm:right-32" />
...
const Hero: React.FC = () => {
  return (
    <>
      ...
      <section
        id="hero"
        className="relative flex items-center justify-center w-full min-h-screen px-6 sm:px-8 md:px-10 pt-44 sm:pt-48 md:pt-52 hero-gradient overflow-hidden"
      >
        {/* Background texture */}
        <BackgroundTexture />
